...
<head>
		...
		<title>Liver Corp (liver support)  by BTP Creations</title>
		...
		<script type="text/javascript">//<![CDATA[
			...
			ThumbURLs[0] = "productimagee4d4.php\/\/cdn2.bigcommerce.com\/n-yp39j5\/2h44pn\/products\/942\/images\/1623\/btpliverCORPbottle__54050.1607525336.1280.1280.png?c=2";ImageDescriptions[0]="";ThumbURLs[1] = "productimagee4d4.php\/\/cdn2.bigcommerce.com\/n-yp39j5\/2h44pn\/products\/942\/images\/1624\/BtpLiverLabel__57206.1607525336.1280.1280.png?c=2";ImageDescriptions[1]="";ThumbURLs[2] = "productimagee4d4.php\/\/cdn2.bigcommerce.com\/n-yp39j5\/2h44pn\/products\/942\/images\/1625\/btpliverFULLlabel__73387.1607525336.1280.1280.png?c=2";ImageDescriptions[2]="";
	...
	<body>
		<div class="Title">
	<h1><div class="ProductImageName" style="position:relative;">Liver Corp (liver support)  by BTP Creations</div></h1>
...
<div class="ImageCarousel" style="display:none;margin:0 auto;">
	...
	<div class="TinyOuterDiv" style = "height:30px; width:30px;">
		<div style = "height:30px; width:30px;">
			<a href="javascript:void(0);" rel='{"gallery": "prodImage", "smallimage": "", "largeimage": ""}'><img id="TinyImage_0" style="padding-top:0px;" width="23" height="30" src="../cdn2.bigcommerce.com/n-yp39j5/2h44pn/products/942/images/1623/btpliverCORPbottle__54050.1607525336.30.304847.png?c=2" alt="" title="" /></a>
		</div>
	</div>
</li>
<li style = "height:34px; width:34px;"  onmouseover="" onclick="showProductZoomImage(1); return false;" id="TinyImageBox_1">
	<div class="TinyOuterDiv" style = "height:30px; width:30px;">
		<div style = "height:30px; width:30px;">
			<a href="javascript:void(0);" rel='{"gallery": "prodImage", "smallimage": "", "largeimage": ""}'><img id="TinyImage_1" style="padding-top:0px;" width="21" height="30" src="../cdn2.bigcommerce.com/n-yp39j5/2h44pn/products/942/images/1624/BtpLiverLabel__57206.1607525336.30.304847.png?c=2" alt="" title="" /></a>
		</div>
	</div>
</li>
<li style = "height:34px; width:34px;"  onmouseover="" onclick="showProductZoomImage(2); return false;" id="TinyImageBox_2">
	<div class="TinyOuterDiv" style = "height:30px; width:30px;">
		<div style = "height:30px; width:30px;">
			<a href="javascript:void(0);" rel='{"gallery": "prodImage", "smallimage": "", "largeimage": ""}'><img id="TinyImage_2" style="padding-top:8px;" width="30" height="13" src="../cdn2.bigcommerce.com/n-yp39j5/2h44pn/products/942/images/1625/btpliverFULLlabel__73387.1607525336.30.304847.png?c=2" alt="" title="" /></a>
		</div>
	</div>
</li>
